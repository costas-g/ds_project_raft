...
local_ip  = '192.168.2.4' # The LAN IP address of the machine where the cluster runs on. Use this for access over the Internet when port forwarding is set up. 
public_ip = '192.168.2.11' # The Public IP address for the clients to direct their requests
...
timing = {
    "batching_interval":    time_scale_factor * 0.025,    #0.015
    "heartbeat_interval":   time_scale_factor * 0.150,    #0.075,
    "election_timeout_min": time_scale_factor * 0.300,    #0.150,
    "election_timeout_max": time_scale_factor * 0.600     #0.300
}

# Imported directly to the raft_node.py file
print_out = False       # for controlling print statements
CLOCK_PERIOD = 0.0005    # for ticker
MAX_LOG = 1000          # maximum local log length